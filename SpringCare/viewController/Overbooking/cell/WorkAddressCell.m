...
- (void) setContentWithModel:(UserAttentionModel*) model
{
    ...
    _lbName.text = [NSString stringWithFormat:@"%@     %@     %@", [model.username isEqual:@""]?@"姓名":model.username,[model.age isEqual:@"0"]?@"年龄":[NSString stringWithFormat:@"%@岁",model.age ],!model.height?@"身高":[NSString stringWithFormat:@"%@米",model.height]];
