...
- (void) setContentWithModel:(UserAttentionModel*) model
{
    ...
    _lbName.text = [NSString stringWithFormat:@"%@     %@     %@", [model.username isEqual:@""]?@"姓名":model.username,[model.age isEqual:@""]?@"年龄":[NSString stringWithFormat:@"%@岁",model.age ],model.height<=0?@"身高":[NSString stringWithFormat:@"%dcm",model.height]];
