...
//        _btnSelect.selected = YES;
        ...
        [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-20-[_logoImage(35)]-20-[_payName]->=10-[_btnSelect]-20-|" options:0 metrics:nil views:views]];
