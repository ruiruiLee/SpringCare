...
//        _btnSelect.selected = YES;
        ...
        [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-10-[_logoImage(35)]-20-[_payName]->=10-[_btnSelect]-20-|" options:0 metrics:nil views:views]];
        ...
        [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-10-[_logoImage(35)]-20-[_line]-0-|" options:0 metrics:nil views:views]];
    }
    return self;
}
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if(self)
    {
        ...
        [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-50-[logo(14)]-5-[lbPaytype]-20-|" options:0 metrics:nil views:views]];
